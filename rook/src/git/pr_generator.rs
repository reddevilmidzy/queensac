...
impl PullRequestGenerator {
    ...
    async fn create_pull_request_via_api(&self) -> Result<String, PrError> {
...
---
*This PR was generated by the Queensac link checker service.*"
            .to_string()
    }
}
...
mod tests {
    ...
    fn create_test_repo() -> (TempDirGuard, RepoManager) {
    ...
    async fn test_replace_line_content() {
        let (_temp_guard, repo_manager) = create_test_repo();
